(() => {
    ...
    function slider() {
        ...
        if (tariffGallerySliders.length) tariffGallerySliders.forEach((slider => {
            new Swiper(slider, {
                speed: 700,
                modules: [ Navigation ],
                grabCursor: true,
        ...
        if (galleryPorfolioSliders.length) galleryPorfolioSliders.forEach((slider => {
            const buttonsPagination = slider.closest(".portfolio__gallery").querySelectorAll(".portfolio__pagination-btn");
            new Swiper(slider, {
                speed: 700,
                modules: [ Autoplay, Pagination ],
                autoplay: true,
